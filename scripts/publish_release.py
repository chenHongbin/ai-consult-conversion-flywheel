#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Atomically publish capability, institution knowledge and patient insight."""
...
from release_utils import atomic_save_json, component_snapshot, load_release_active, release_root, scope_conflicts
...
def main():
    ...
    atomic_save_json(release_dir / "release.json", release)
    atomic_save_json(release_root_path / "active.json", {
        "schema_version": "1.0",
        "status": "active",
        "release_id": release_id,
        "release_version": version,
        "release_path": str(release_dir / "release.json"),
